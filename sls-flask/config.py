...
# use local "sls-flask" DB for local dev
DEFAULT_DB_URL = "postgresql:///sls-flask"
...
class Config:
    ...
    APP_SECRETS_NAME = os.getenv("APP_SECRETS_NAME", "sls-flask/dev")
...
class ProductionConfig(Config):
    ...
    APP_SECRETS_NAME = "sls-flask/prd"
...
def check_valid_handler(event, context):
    ...
    config_class = event.get("env", "sls-flask.config.LocalDevConfig")
