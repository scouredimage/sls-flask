...
from sls-flask.api import init_views
from sls-flask.create_app import create_app
from flask_jwt_extended import create_access_token
from sls-flask.db.fixtures import NormalUserFactory
...
DB_CONN = os.getenv("SQLALCHEMY_DATABASE_URI", "postgresql:///sls-flask_test".lower())
